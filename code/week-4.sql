...
-- cast 함수()
SELECT timestampe_col, CAST(timestamp_col AS varchar(10))
FROM data_time_types;

SELECT numeric_colmn,
	CAST(numeric_column AS integer),
	CAST(numeric_column AS text)
FROM num_data_types;

--SELECT CAST(char_column AS integer) FROM char_data; --오류발생